...
const allOutingsData = sortiesData;

// --- Simulation de l'utilisateur connecté ---
const currentUser = { role: "admin" }; // 'user' | 'moderator' | 'admin'
...
const createOutingSchema = z.object({
  ...
  if (data.isRecurring) return !!data.recurrenceFrequency && !!data.recurrenceEndDate;
  return true;
}, {
...
export default function CreateOutingForm({ duplicateId }) {
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              {watchMainCategory === "Sport" && (
                <div className="grid gap-2">
                  ...
                  <Controller
                    name="sportSubCategory"
                    control={control}
                    render={({ field }) => (
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <SelectTrigger><SelectValue placeholder="Sélectionnez..." /></SelectTrigger>
                        <SelectContent>
                          {sportSubCategories.map((subCat) => (
            ...
            <div className="grid gap-2">
              ...
              <div className="flex items-center gap-4">
                <div className="w-32 h-32 relative border rounded-md flex items-center justify-center bg-muted">
                  {photoPreview ? (
                    // ✅ syntaxe Image moderne
                    <Image src={photoPreview} alt="Aperçu" fill className="rounded-md object-cover" />
                  ) : (
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground">
              Besoin d'aide ?{" "}
              <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" className="text-primary underline">
                Ouvrir Google Maps <ExternalLink className="inline h-4 w-4" />
              </a>
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-2">
                ...
                render={({ field }) => (
                  <div className="flex items-center gap-4">
                    <Slider
                      ...
                      className="flex-1"
                    />
                    {/* field.value est un tableau [n] */}
                    <span className="w-12 text-center font-bold p-2 border rounded-md">
              ...
              <p className="text-sm text-muted-foreground">
                A visto de Naz combien penses tu de gens tu vas pouvoir mettre ?
              </p>
            </div>
